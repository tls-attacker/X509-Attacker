...
public class CertificateRewriterTest {
    ...
    public void testRewriteCertificate() {
        ...
        parser.parse(new BufferedInputStream(new ByteArrayInputStream(originalCertificate)));
        ...
        X509CertificatePreparator preparator =
                new X509CertificatePreparator(chooser, x509Certificate);
        preparator.prepare();
        ...
        preparator = new X509CertificatePreparator(chooser, x509Certificate);
        preparator.prepare();
        serializedCertificate = x509Certificate.getSerializer(chooser).serialize();
        LOGGER.info(
