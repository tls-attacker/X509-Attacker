...
public class Asn1Ia5StringValueTest {

    @Test
    public void testAsn1Ia5StringEncoding() {
        Asn1Ia5String asn1Ia5String = new Asn1Ia5String();
        Asn1Ia5String.Asn1Ia5StringValue asn1Ia5StringValue = new Asn1Ia5String.Asn1Ia5StringValue();
        byte[] encoded;

        // string "test1@rsa.com"
        asn1Ia5StringValue.setAsn1Ia5StringValue("test1@rsa.com");
        asn1Ia5String.addField(asn1Ia5StringValue);
