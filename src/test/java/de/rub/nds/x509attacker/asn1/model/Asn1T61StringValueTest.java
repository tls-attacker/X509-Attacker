...
public class Asn1T61StringValueTest {

    @Test
    public void testAsn1T61StringEncoding() {
        Asn1T61String asn1T61String = new Asn1T61String();
        Asn1T61String.Asn1T61StringValue asn1T61StringValue = new Asn1T61String.Asn1T61StringValue();
        byte[] encoded;

        // string "Test User 1"
        asn1T61StringValue.setAsn1T61StringValue("cl'es publiques");
        asn1T61String.addField(asn1T61StringValue);
