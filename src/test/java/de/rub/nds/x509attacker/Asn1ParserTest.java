   ...
   @Test
    public void testAsn1Parser() throws ParserException {
        ...
        try {
            ...
            /*
            //Test von Encapsulated BitStrings
            //certificateContent = hexStringToByteArray("040403020186");
            certificateContent = hexStringToByteArray("04050303070400"); 
            Asn1Parser asn1Parser = new Asn1Parser(certificateContent, false);
            List<Asn1Encodable> asn1Encodables = asn1Parser.parse(TestEncapsulatingExtensionContext.NAME);
            */
            
            //Test von ExtensionContent only/ Unterscheiden zwischen Boolean und octedString
            byte[] extensionContent = hexStringToByteArray("0603551D23041830168014BBAF7E023DFAA6F13C848EADEE3898ECD93232D4");
    ...
    private static void registerContexts() {
        ...
        contextRegister.registerContext(TestEncapsulatingExtensionContext.NAME, TestEncapsulatingExtensionContext.class);
