...
public class X509Factory {
    ...
    public static X509Certificate getRandomX509CertificateFromFolder(File certificateFolder)  throws IOException, JAXBException, XMLStreamException
    {   
        return getRandomX509CertificateFromFolder(certificateFolder, null, null);
    }
    
    public static X509Certificate getRandomX509CertificateFromFolder(File certificateFolder, File keyFolder)  throws IOException, JAXBException, XMLStreamException
    {   
        return getRandomX509CertificateFromFolder(certificateFolder, keyFolder, null);
    }
    
    public static X509Certificate getRandomX509CertificateFromFolder(File certificateFolder, File keyFolder, KeyType keyType)  throws IOException, JAXBException, XMLStreamException
    {   
        ...
        if (certificateFolder.exists() && certificateFolder.isDirectory()) {
            ...
            do {                
                ...
                try {
                    ...
                    LOGGER.warn("getRandomX509CertificateFromFolder(): Could not parse Random X509Certificate: "+ chosenFile.getAbsolutePath() + " Exception: " + E);
                }
                tries++;
            ...
            throw new IOException("Cannot generate a new X509Certificate from " + certificateFolder.getAbsolutePath() + "(not exists or no directory)");
        }       
    ...
    public static X509CertificateChain generateRandomX509CertificateChain(File certificateFolder, File keyFolder, int numberOfCerts, RepairChainConfig repairConfig) throws IOException, JAXBException, XMLStreamException
    {
