...
public class X509CertificateConfig {
    ...
    private BigInteger defaultIssuerRsaModulus = new BigInteger(
            "",
            16);
    ...
    private BigInteger dsaPublicKeyY = new BigInteger(
            1,
    ...
    private BigInteger defaultIssuerDsaPublicKeyY = new BigInteger(
            1,
            ArrayConverter.hexStringToByteArray(
                    ""));
    ...
    private BigInteger dhPublicKey = new BigInteger(
     ...
     * was super small
     */
    private BigInteger dhPrivateKey = new BigInteger("D0EC4E50BB290A42E9E355C73D8809345DE2E139", 16);

    private BigInteger dhModulus = new BigInteger(
    ...
    private BigInteger dsaPrimeP = new BigInteger(
            1,
            ArrayConverter.hexStringToByteArray(
    ...
    private BigInteger dsaPrimeQ = new BigInteger(
            1,
            ArrayConverter.hexStringToByteArray(
                    "E950511EAB424B9A19A2AEB4E159B7844C589C4F"));

    private BigInteger dsaGenerator = new BigInteger(
            1,
            ArrayConverter.hexStringToByteArray(
    ...
    private BigInteger defaultIssuerRsaPrivateKey = new BigInteger(
            "",
            16);

    private BigInteger defaultIssuerDsaPrivateKey = new BigInteger("D0EC4E50BB290A42E9E355C73D8809345DE2E139", 16);
