    ...
    private BasicConstraints(IntermediateAsn1Field intermediateAsn1Field, String identifier) {
        ...
        while (amountOptionalFields > 0) {
            ...
            if (intermediateAsn1Field.getChildren().get(index).getTagNumber() == TagNumber.BOOLEAN.getIntValue()) {
                ca = (Asn1Boolean) X509Translator.translateSingleIntermediateField(
                    intermediateAsn1Field.getChildren().get(index++), Asn1BooleanFT.class, "ca", "");
                asn1.addChild(ca);
            }
            ...
            // pathLenConstraint - can be optional
                ...
                pathLenConstraint = (Asn1Integer) X509Translator.translateSingleIntermediateField(
                    intermediateAsn1Field.getChildren().get(index++), Asn1IntegerFT.class, "pathLenConstraint", "");
                asn1.addChild(pathLenConstraint);

            } else {
                LOGGER.warn("Parser Error: BasicConstraint -> Else Case triggerd; no Parser defined for Tag Number: "
