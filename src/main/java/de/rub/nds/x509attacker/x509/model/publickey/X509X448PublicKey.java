...
import de.rub.nds.x509attacker.x509.handler.publickey.X509X448PublicKeyHandler;
...
public class X509X448PublicKey extends Asn1OctetString implements PublicKeyContent, X509Component {

    public X509X448PublicKey() {
        super("x448PublicKey");
    }
    ...
    public X509Parser getParser(X509Chooser chooser) {
        return new de.rub.nds.x509attacker.x509.parser.publickey.X509X448PublicKeyParser(
                chooser, this);
    }

    @Override
    public X509Preparator getPreparator(X509Chooser chooser) {
        return new de.rub.nds.x509attacker.x509.preparator.publickey.X448PublicKeyPreparator(
                chooser, this);
    }
