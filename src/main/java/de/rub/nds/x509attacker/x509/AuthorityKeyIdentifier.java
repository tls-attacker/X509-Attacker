        ...
        for(IntermediateAsn1Field interFieldChild : intermediateAsn1Field.getChildren()) {
             ...
             switch(interFieldChild.getTagNumber())  {
                ...
                case 0: //KeyIdentifier
                    keyIdentifier = (Asn1PrimitiveOctetString) X509Translator.translateSingleIntermediateField(interFieldChild, Asn1PrimitiveOctetStringFT.class , "keyIdentifier", "KeyIdentifier");
                ...
                case 2: //CertificateSerialNumber
                    authorityCertSerialNumber = (Asn1Integer) X509Translator.translateSingleIntermediateField(interFieldChild, Asn1IntegerFT.class , "authorityCertSerialNumber", "CertificateSerialNumber");
                    asn1.addChild(authorityCertSerialNumber);
                    break;

                default:
                    LOGGER.warn("Parser Error: AuthorityKeyIdentifier -> Default Case triggerd; no Parser defined for Tag Number: " + interFieldChild.getTagNumber());
            }
