...
public class ExplicitRelativeDistinguishedName extends X509Model<Asn1Explicit> {
    ...
    public static ExplicitRelativeDistinguishedName getInstance(IntermediateAsn1Field intermediateAsn1Field, String identifier){
    ...
    private ExplicitRelativeDistinguishedName(IntermediateAsn1Field intermediateAsn1Field, String identifier)
    {
        ...
        {
            relativeDistinguishedName = RelativeDistinguishedName.getInstance(intermediateAsn1Field.getChildren().get(0), identifier);
        }
