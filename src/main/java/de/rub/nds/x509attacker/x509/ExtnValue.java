...
public class ExtnValue extends X509Model<Asn1EncapsulatingOctetString> {
    ...
    {
        asn1 = (Asn1EncapsulatingOctetString) X509Translator.translateSingleIntermediateField(intermediateAsn1Field, Asn1EncapsulatingOctetStringFT.class , identifier, type);
        
        switch(oid) {
            
            case AuthorityKeyIdentifier.OID:
                extensionValue = AuthorityKeyIdentifier.getInstance(intermediateAsn1Field.getChildren().get(0), "authorityKeyIdentifier");               
                asn1.addChild(extensionValue.asn1);
                break;
                
            case SubjectKeyIdentifier.OID:
                extensionValue = SubjectKeyIdentifier.getInstance(intermediateAsn1Field.getChildren().get(0), "subjectKeyIdentifier");
                asn1.addChild(extensionValue.asn1);
                break;
            ...
            case BasicConstraints.OID:
                extensionValue = BasicConstraints.getInstance(intermediateAsn1Field.getChildren().get(0), "basicConstraints");
                asn1.addChild(extensionValue.asn1);
                break;
            ...
            case CertificatePolicies.OID:
                extensionValue = CertificatePolicies.getInstance(intermediateAsn1Field.getChildren().get(0), "certificatePolicies");
                asn1.addChild(extensionValue.asn1);
                break;
               
            
            case CRLDistributionPoints.OID:
                extensionValue = CRLDistributionPoints.getInstance(intermediateAsn1Field.getChildren().get(0), "crlDistributionPoints");
                asn1.addChild(extensionValue.asn1);
                break;
                
            case AuthorityInfoAccess.OID:
                extensionValue = AuthorityInfoAccess.getInstance(intermediateAsn1Field.getChildren().get(0), "authorityInfoAccess");
                asn1.addChild(extensionValue.asn1);
                break;
            ...
            case signedCertificateTimestampList.OID:
                extensionValue = signedCertificateTimestampList.getInstance(intermediateAsn1Field.getChildren().get(0), "signedCertificateTimestampList");
                asn1.addChild(extensionValue.asn1);
                break;
            
            default:
                LOGGER.warn("Parser Error: ExtnValue -> Default Case triggerd; no Parser defined for Extension OID: " + oid);
                break;
