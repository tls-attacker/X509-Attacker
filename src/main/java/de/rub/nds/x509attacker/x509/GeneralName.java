        ...
        //Choice
         switch(intermediateAsn1Field.getTagNumber())  {
            ...
            case 1: //rfc822Name  [1]  IA5String
                asn1 = (Asn1PrimitiveIa5String) X509Translator.translateSingleIntermediateField(true, intermediateAsn1Field, Asn1PrimitiveIa5StringFT.class , identifier, "rfc822Name");
            ...
            case 2: //dNSName    [2]  IA5String
                asn1 = (Asn1PrimitiveIa5String) X509Translator.translateSingleIntermediateField(true, intermediateAsn1Field, Asn1PrimitiveIa5StringFT.class , identifier, "dNSName");
                choice = new X509Model<Asn1PrimitiveIa5String>();
                choice.asn1 = asn1;                
                break;
            ...
            case 6: //uniformResourceIdentifier [6]  IA5String
                asn1 = (Asn1PrimitiveIa5String) X509Translator.translateSingleIntermediateField(true, intermediateAsn1Field, Asn1PrimitiveIa5StringFT.class , identifier, "uniformResourceIdentifier"); 
                choice = new X509Model<Asn1PrimitiveIa5String>();
                choice.asn1 = asn1; 
                break;

            case 7: //iPAddress  [7]  OCTET STRING
                asn1 = (Asn1PrimitiveOctetString) X509Translator.translateSingleIntermediateField(true, intermediateAsn1Field, Asn1PrimitiveOctetStringFT.class , identifier, "iPAddress");
                choice = new X509Model<Asn1PrimitiveOctetString>();
                choice.asn1 = asn1;
                break;

            case 8: //registeredID  [8]  OBJECT IDENTIFIER
                asn1 = (Asn1ObjectIdentifier) X509Translator.translateSingleIntermediateField(true, intermediateAsn1Field, Asn1ObjectIdentifierFT.class , identifier, "registeredID");
                choice = new X509Model<Asn1ObjectIdentifier>();
                choice.asn1 = asn1; 
                break;

            default:
                LOGGER.warn("Parser Error: GeneralName -> Default Case triggerd; no Parser defined for Tag Number: " + intermediateAsn1Field.getChildren().get(0).getTagNumber());
        }  
         
         if(warningNewType == true) {
             //LOGGER.warn("Testing required: Parsing of yet untested type of GeneralName; with Tag: " + intermediateAsn1Field.getTagNumber());
         }
