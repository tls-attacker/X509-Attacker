...
public class X509Ed25519PublicKeyParser extends X509ComponentParser<X509Ed25519PublicKey> {

    private static final Logger LOGGER = LogManager.getLogger();

    public X509Ed25519PublicKeyParser(X509Chooser chooser, X509Ed25519PublicKey ed25519PublicKey) {
        super(chooser, ed25519PublicKey);
    }

    @Override
    public void parse(BufferedInputStream inputStream) {
        LOGGER.debug("Parsing X509Ed25519PublicKey");
        ParserHelper.parseAsn1OctetString(encodable, inputStream);
        LOGGER.debug("Parsed Ed25519 public key");
    }
}
