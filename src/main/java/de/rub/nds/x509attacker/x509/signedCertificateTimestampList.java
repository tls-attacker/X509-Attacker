...
public class signedCertificateTimestampList extends X509Model<Asn1PrimitiveOctetString> {
    ...
    public static signedCertificateTimestampList getInstance(IntermediateAsn1Field intermediateAsn1Field, String identifier){
    ...
    {        
        asn1 = (Asn1PrimitiveOctetString) X509Translator.translateSingleIntermediateField(intermediateAsn1Field, Asn1PrimitiveOctetStringFT.class , identifier, type);        
    } 
