...
import de.rub.nds.x509attacker.x509.base.publickey.RsaPublicKeyContentSequence;
import java.io.IOException;
import java.io.InputStream;

public class RsaPublicKeyParser extends Asn1Parser<X509Chooser, RsaPublicKey> {

    public RsaPublicKeyParser(X509Chooser chooser, RsaPublicKey rsaPublicKey) {
    ...
    public void parseIndividualContentFields(InputStream inputStream) throws IOException {
        RsaPublicKeyContentSequence rsaContentSequence = encodable.getRsaPublicKeyContentSequence();
        encodable
                .getRsaPublicKeyContentSequence()
                .getParser(chooser)
