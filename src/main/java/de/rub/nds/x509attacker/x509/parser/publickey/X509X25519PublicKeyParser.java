...
public class X509X25519PublicKeyParser extends X509ComponentParser<X509X25519PublicKey> {

    private static final Logger LOGGER = LogManager.getLogger();

    public X509X25519PublicKeyParser(X509Chooser chooser, X509X25519PublicKey x25519PublicKey) {
        super(chooser, x25519PublicKey);
    }

    @Override
    public void parse(BufferedInputStream inputStream) {
        LOGGER.debug("Parsing X509X25519PublicKey");
        ParserHelper.parseAsn1OctetString(encodable, inputStream);
        LOGGER.debug("Parsed X25519 public key");
    }
}
