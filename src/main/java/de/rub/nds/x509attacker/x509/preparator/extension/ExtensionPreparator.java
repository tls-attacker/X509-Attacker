...
/**
 * Parent preparator for {@link Extension} objects. Prepares the OID, criticality, and extension bytes. Delegates
 * extension preparation to the implementing subclass.
 */
public abstract class ExtensionPreparator<Encodable extends Extension, Config extends  ExtensionConfig> extends X509ContainerPreparator<Encodable> {
