...
public class X509Asn1OctetString extends Asn1OctetString implements X509Field, X509Asn1ValueHolder {
    ...
    protected void encodeForParentLayer() {
        this.addFieldsToAsn1OctetString();
        super.encodeForParentLayer();
    }

    private void addFieldsToAsn1OctetString() {
