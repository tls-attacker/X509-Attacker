...
public class SubjectKeyIdentifierHandler extends X509FieldHandler<SubjectKeyIdentifier> {
    public SubjectKeyIdentifierHandler(X509Chooser chooser, SubjectKeyIdentifier component) {
