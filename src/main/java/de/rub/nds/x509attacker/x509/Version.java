...
public class Version extends X509Model<Asn1Explicit> {
    ...
    private Version(IntermediateAsn1Field intermediateAsn1Field, String identifier)
    {
        ...
        asn1 = (Asn1Explicit) X509Translator.translateSingleIntermediateField(intermediateAsn1Field, Asn1ExplicitFT.class , "explicit" + identifier, "ExplicitContainer");
        
        version = (Asn1Integer) X509Translator.translateSingleIntermediateField(intermediateAsn1Field.getChildren().get(0), Asn1IntegerFT.class , identifier, type);
