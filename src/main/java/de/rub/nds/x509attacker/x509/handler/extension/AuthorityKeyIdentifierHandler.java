...
public class AuthorityKeyIdentifierHandler extends X509FieldHandler<AuthorityKeyIdentifier> {
    public AuthorityKeyIdentifierHandler(X509Chooser chooser, AuthorityKeyIdentifier component) {
