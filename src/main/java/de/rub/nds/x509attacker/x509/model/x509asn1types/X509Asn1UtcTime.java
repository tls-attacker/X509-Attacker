...
public class X509Asn1UtcTime extends Asn1UtcTime implements X509Field, X509Asn1ValueHolder {
    ...
    protected void encodeForParentLayer() {
        this.addFieldsToAsn1UtcTime();
        super.encodeForParentLayer();
    }

    private void addFieldsToAsn1UtcTime() {
        super.clearFields();
